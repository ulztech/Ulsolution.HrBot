...
namespace Ulsolution.HrBot.Bots
{
    ...
    public class DialogBotActivityHandler<T> : ActivityHandler
        where T : Dialog
    {
        ...
        public DialogBotActivityHandler(ConversationState conversationState, UserState userState, T dialog, ILogger<DialogBotActivityHandler<T>> logger)
        {
